...
(function(global, factory) {
  ...
  var EZUIPlayer = function(playParams) {
    ...
    // 获取appKey
    request(
      domain + '/jssdk/ezopen/getAppInfo?uuid=' + playUid + '&accessToken=' + accessToken + '&deviceSerial=' + deviceSerial + '&channelNo=1',
      'GET',
      '',
      '',
      appInfoSuccess,
  ...
  EZUIPlayer.prototype.getRealUrl = function(playParams) {
    ...
    if (playParams.url.indexOf('open.ezvizlife.com') !== -1) {
      ///海外
    ...
    function initDecoder(resolve, reject) {
      ...
      addJs(jsPluginPath, function() {
        ...
        if (playParams.controls && playParams.controls.length > 0) {
          ...
          const setPlayStatusCallBack = (status) => {
          ...
          const setVoiceStatusCallBack = (status) => {
          ...
          const setHdStatusCallBack = (status) => {
          ...
          const setFullScreenStatusCallBack = (status) => {
